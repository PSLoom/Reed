# The "typical draft" the startup budget is defined against: about twenty verbs, Reed threaded and already installed.
# Measure-Startup.ps1 dot-sources it after Import-Module PSLoom and times it.
Invoke-Loom -Draft {
  Thread Reed
